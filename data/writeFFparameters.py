...
def make_alpha_file():
    AA_list = [
        'ARG', 'ASN', 'ASP', 'CYS', 'GLN', 'GLU', 'HIS', 'ILE', 'LEU', 'MET', 'PHE', 'PRO', 'SER', 'THR', 'TRP',
        'TYR', 'VAL', 'ALA', 'ASH', 'CYD', 'GLH', 'GLY', 'HID', 'HIE', 'LYD', 'LYS', 'CYX'
    ]
    cap_list = [
        '_charged_methyl', '_neutral_methyl', '_methyl_charged', '_methyl_neutral', '_methyl_methyl', '_ACE', '_NME'
    ]
            ...
            if parameters[i, 0][0] == 'C' and parameters[i, 0][1] != 'Y':
                ...
                for j in range(0, len(fitoutput)):
                    if fitoutput[j][0:3] == 'Fin':
                        ...
                        alpha = np.genfromtxt('fittedparameters/alpha_' + parameters[i, 0][1:] +
                                              '_methyl_charged.out.txt')[6:]
                ...
                for j in range(0, len(fitoutput)):
                    if fitoutput[j][0:3] == 'Fin':
                        ...
                        for k in range(0, len(charges)):
                            charges[k] = charges[k][:-1]
                        alpha = np.genfromtxt('fittedparameters/alpha_' + parameters[i, 0][:] +
                                              '_methyl_methyl.out.txt')
