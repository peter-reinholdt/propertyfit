...
polarizability_axis_nonzero[('zthenx', (1, 1, 1, 1))] = [True]*6
polarizability_axis_nonzero[('zthenx', (3, 1))] = [True]*6
polarizability_axis_nonzero[('zthenx', (2, 1))] = [True]*6
polarizability_axis_nonzero[('zthenx', 3)] = [True]*6
polarizability_axis_nonzero[('zthenx', (1, 1, 1))] = [True]*6
polarizability_axis_nonzero[('zthenx', 2)] = [True]*6
polarizability_axis_nonzero[('zthenx', (1, 1))] = [True]*6
polarizability_axis_nonzero[('zthenx', (1, 2, 1))] = [True]*6
polarizability_axis_nonzero[('zthenx', (1, 3))] = [True]*6
polarizability_axis_nonzero[('zthenx', (1, 1, 1, 1))] = [True]*6
polarizability_axis_nonzero[('zthenx', (1, 2))] = [True]*6
polarizability_axis_nonzero[('zthenx', (1, 1, 1))] = [True]*6
polarizability_axis_nonzero[('zthenx', (1, 1))] = [True]*6
polarizability_axis_nonzero[('bisector', (2, 1, 1))] = [True]*6
polarizability_axis_nonzero[('bisector', (2, 2))] = [True]*6
polarizability_axis_nonzero[('bisector', (1, 1, 1, 1))] = [True]*6
polarizability_axis_nonzero[('bisector', (3, 1))] = [True]*6
polarizability_axis_nonzero[('bisector', (2, 1))] = [True]*6
polarizability_axis_nonzero[('bisector', 3)] = [True]*6
polarizability_axis_nonzero[('bisector', (1, 1, 1))] = [True]*6
polarizability_axis_nonzero[('bisector', 2)] = [True]*6
polarizability_axis_nonzero[('bisector', (1, 1))] = [True]*6
polarizability_axis_nonzero[('bisector', (1, 2, 1))] = [True]*6
polarizability_axis_nonzero[('bisector', (1, 3))] = [True]*6
polarizability_axis_nonzero[('bisector', (1, 1, 1, 1))] = [True]*6
